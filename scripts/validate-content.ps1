...
$expectedGuidedNames = @(1..12 | ForEach-Object { "lesson-{0:D2}-guided.js" -f $_ })
if ((@($guidedFiles.Name) -join "|") -cne ($expectedGuidedNames -join "|")) { $errors.Add("Lesson 1-12 guided dosyaları eksiksiz ve sıralı keşfedilmedi.") }
...
$lesson12ScriptIndex = [array]::IndexOf($actualScriptOrder, "src/data/lesson-12-guided.js")
$uiCopyScriptIndex = [array]::IndexOf($actualScriptOrder, "src/js/ui-copy.js")
if ($lesson12ScriptIndex -lt 0 -or $uiCopyScriptIndex -lt 0 -or $lesson12ScriptIndex -ge $uiCopyScriptIndex) { $errors.Add("Lesson 12 guided script UI/runtime scriptlerinden önce yüklenmiyor.") }
