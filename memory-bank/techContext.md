...
- `src/data/lesson-01-guided.js` ve `src/data/lesson-02-guided.js`, ilk iki dersin doğrulanmış kaynak kavramlarını yeni başlayanlara uygun öğretim adımlarına dönüştüren ek katmanlardır; ana JSON'u değiştirmez.
...
- Doğrulama scripti 1. ve 2. dersin bütün core/recognize ID'lerini, her recognize terimin tam bir bağlamsal karta yalnızca bir kez yerleşmesini, bütün core konuların zorunlu öğretim alanlarını, ders özetlerini ve guided rota/aksiyon bağlantılarını kontrol eder.
