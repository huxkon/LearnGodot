  ...
  window.GODOT_CURRICULUM = {
    ...
    lessons: {
      tr: {
        ...
        "lesson-07": { lessonId: "lesson-07", displayTitle: "Görseller, Kamera ve Animasyon", displayDescription: "Sprite, TileMapLayer, kamera, animasyon ve oyunun ekranda nasıl gösterildiğiyle ilgili temel kavramları öğren.", section: "gorsel-arayuz", order: 7, technicalTopics: ["Sprite", "TileMapLayer", "Camera", "Animation"] },
